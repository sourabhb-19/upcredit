                    ...
                    <Row className="align-items-center">
                        ...
                        <Col md={7}>
                            <div className="commonHeading mt-2 mt-md-0  mb-0">
                                ...
                                <h2 className="commonHeading_title mt-3 text-dark">Get your <span>financial future</span> secured with Dispute Beast</h2>
                                <p className="commonHeading_cnt ">Take the first step towards a better financial future today. You deserve financial freedom because you’re more than a credit score and Dispute Beast is here to help you achieve it.</p>
