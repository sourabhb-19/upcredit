    ...
    return(
        <>
            <section className="creditScore">
                <Container>
                    <div className="creditScore_wrap text-center d-flex flex-column justify-content-center">
                        <div className="commonHeading zindex-1 position-relative mb-0">
                            ...
                            <h2 className="commonHeading_title mt-3 mb-4">We've helped thousands of users <br /> increase their <span>credit score</span> </h2>
