                    ...
                    <Container className="h-100"    >
                        <Row className="align-items-center justify-content-center h-100">
                            <Col sm={12} md={10} className="align-items-center ">
                                ...
                                <p className="bannerSubtitle text-white py-2 py-xl-3" data-aos="fade-up" data-aos-delay="200" data-aos-duration="800" data-aos-easing="linear">Your ultimate DIY Credit dispute assistant tool with a 100% Money-back guarantee.</p>
